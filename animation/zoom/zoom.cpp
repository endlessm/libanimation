...
namespace
{
    ...
    {
        auto const &topLeft = box.topLeft();
        auto const &bottomRight = box.bottomRight();
        auto x1 = agd::get <0> (topLeft);
        auto y1 = agd::get <1> (topLeft);
        auto x2 = agd::get <0> (bottomRight);
        auto y2 = agd::get <1> (bottomRight);
                               ...
                               animation::Box <animation::Point> const &to)
    {
        ...
        /* Remember that transformation are done back to front when postmultiplying.
         *
