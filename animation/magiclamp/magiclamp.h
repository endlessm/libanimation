    ...
    namespace magiclamp
    {
            ...
            public animation::grid::GridAnimation
        {
            public:
                ...
                MagicLampAnimation ();
                MagicLampAnimation (animation::BoxQuery <animation::Point>::Shared        const &source,
                ...
                ANIMATION_DECLARE_PROPERTY (MagicLampAnimation, Source, animation::BoxQuery <animation::Point>::Shared)
                ANIMATION_DECLARE_PROPERTY (MagicLampAnimation, Target, animation::BoxQuery <animation::Point>::Shared)
                ...
                ANIMATION_DECLARE_PROPERTY (MagicLampAnimation, Stepper, animation::stepper::Stepper::Shared)
