...
namespace animation
{
    namespace glide
    {
        struct GlideAnimation::Private
        {
            ...
            float xAxisLocationUnit;
            float yAxisLocationUnit;
            animation::BoxQuery <animation::Point>::Shared viewportQuery;
...
ag::GlideAnimation::Step (unsigned int ms)
{
    ...
    auto viewport = priv->viewportQuery->Geometry ();
...
ANIMATION_DEFINE_PROPERTY (ag::GlideAnimation, Stepper, animation::stepper::Stepper::Shared, priv->stepper)
ANIMATION_DEFINE_PROPERTY (ag::GlideAnimation, Viewport, animation::BoxQuery <animation::Point>::Shared, priv->viewportQuery)
ANIMATION_DEFINE_PROPERTY (ag::GlideAnimation, Target, animation::BoxQuery <animation::Point>::Shared, priv->targetQuery)
...
ag::GlideAnimation::GlideAnimation (float                                                 initialDistance,
                                    ...
                                    std::shared_ptr <animation::stepper::Stepper>  const &stepper) :
