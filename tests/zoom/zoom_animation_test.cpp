...
namespace
{
    ...
    {
        az::ZoomAnimation anim (BQ (animation::Box <animation::Point> (animation::Point (0, 0),
                                                                       animation::Point (100, 100))),
                                BQ (animation::Box <animation::Point> (animation::Point (100, 100),
    ...
    {
        az::ZoomAnimation anim (BQ (animation::Box <animation::Point> (animation::Point (100, 100),
                                                                       animation::Point (200, 200))),
                                BQ (animation::Box <animation::Point> (animation::Point (200, 200),
