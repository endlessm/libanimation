 ...
 *
 * Tests for the "magic lamp" animation.
 */
...
namespace
{
    ...
    {
        aml::MagicLampAnimation anim (BQ (animation::Box <animation::Point> (animation::Point (100, 100),
    ...
    TEST (MagicLampAnimation, CorrectLinearInterpolatedVertexDeformation)
    {
        ...
        aml::MagicLampAnimation anim (BQ (animation::Box <animation::Point> (animation::Point (iconX, iconY),
                                                                             animation::Point (iconX + iconWidth, iconY + iconHeight))),
                                      BQ (animation::Box <animation::Point> (animation::Point (x, y),
