...
/**
 * animation_transform_animation_extremes: (skip)
 * @transform_animation: A #AnimationTransformAnimation
...
/**
 * animation_transform_animation_alloc_extremes: (rename-to animation_transform_animation_extremes)
 * @transform_animation: A #AnimationTransformAnimation
 * @corners: (array fixed-size=4): The four #AnimationVector4D values
 *           describing the location of the surface corners.
 *
 ...
 */
AnimationVector4D *
animation_transform_animation_alloc_extremes (AnimationTransformAnimation *transform_animation,
                                              AnimationVector const       *corners)
{
  AnimationVector4D *out_array = g_new0 (AnimationVector4D, 4);

  animation_transform_animation_extremes (transform_animation, corners, out_array);
  return out_array;
}
